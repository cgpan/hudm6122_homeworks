...
cc_test <- function(eigenvalues, n, q1,q2){
  # eigenvalues is a list of a eigenvalues computed by hand.
  # s_df is the df of the s matrix, ie., the n in the equation
  # p_q is
...
```  
Write separate code chunk to calculate the eigenvalues of `headsize` dataset. Based on the dimension of dataset, we can easily find the `q1` = 2, `q2` = 2, and the df of s matrix is 
```{r}
# import the data
...
r12 <- R[1:2, -(1:2)]
r21 <- R[-(1:2), 1:2]
# since the eigenvalues are the same for E1 and E2, here I only compute E1
