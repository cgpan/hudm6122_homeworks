...
\SpecialCharTok{+}                   \StringTok{"Arithmetic"}\NormalTok{,}\StringTok{"Algebra"}\NormalTok{,}\StringTok{"Geometry"}\NormalTok{),}\DecValTok{3}\NormalTok{),}\AttributeTok{cex=}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\ErrorTok{\textgreater{}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(f) }
\SpecialCharTok{+}   \FunctionTok{factanal}\NormalTok{(}\AttributeTok{covmat=}\FunctionTok{as.matrix}\NormalTok{(corr\_symmetric), }
\SpecialCharTok{+}            \AttributeTok{factors=}\NormalTok{f, }\AttributeTok{method=}\StringTok{"mle"}\NormalTok{, }\AttributeTok{n.obs =} \DecValTok{123}\NormalTok{)}\SpecialCharTok{$}\NormalTok{PVAL)}
\NormalTok{   objective    objective    objective    objective    objective }
\FloatTok{3.582705e{-}23} \FloatTok{3.330276e{-}06} \FloatTok{8.377428e{-}02} \FloatTok{1.370264e{-}01} \FloatTok{3.166230e{-}01} 
\end{Highlighting}
\end{Shaded}
