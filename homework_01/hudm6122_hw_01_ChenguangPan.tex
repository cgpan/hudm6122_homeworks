...
\NormalTok{ [}\DecValTok{9}\NormalTok{,]   }\SpecialCharTok{{-}}\DecValTok{6}   \SpecialCharTok{{-}}\DecValTok{9}    \DecValTok{1}   \SpecialCharTok{{-}}\DecValTok{2}    \DecValTok{0}    \DecValTok{4}    \DecValTok{3}   \SpecialCharTok{{-}}\DecValTok{1}    \DecValTok{0}     \DecValTok{2}
\NormalTok{[}\DecValTok{10}\NormalTok{,]   }\SpecialCharTok{{-}}\DecValTok{8}  \SpecialCharTok{{-}}\DecValTok{11}   \SpecialCharTok{{-}}\DecValTok{1}   \SpecialCharTok{{-}}\DecValTok{4}   \SpecialCharTok{{-}}\DecValTok{2}    \DecValTok{2}    \DecValTok{1}   \SpecialCharTok{{-}}\DecValTok{3}   \SpecialCharTok{{-}}\DecValTok{2}     \DecValTok{0}
\end{Highlighting}
\end{Shaded}
